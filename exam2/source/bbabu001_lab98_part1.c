...
typedef enum detect_eq_states { DEQInit, detect, dwait} detect_eq_states;
typedef enum detect_max_amp_states { DMAInit, DMAeq} detect_max_amp_states;
typedef enum detect_zc_states { DZCInit, E, W, N, S, NE, NW, sE, sW} detect_zc_states;
